        ...
        <div className="p-4 lg:w-1/4 md:w-1/2 w-full" onClick={handleClick}>
            ...
            >
                ...
                <div className="relative w-full h-56 rounded-xl overflow-hidden bg-gray-50 mb-4">
                    ...
                    <img
                        alt={product.title}
                        className={`w-full h-full object-contain object-center transition-all duration-500 ${isHovered ? 'scale-110' : 'scale-100'
                ...
                <div className="w-full space-y-3">
                    ...
                    <div className="flex items-center justify-center space-x-2">
                        ...
                        <div className={`w-2 h-2 bg-green-500 rounded-full transition-all duration-300 ${isHovered ? 'animate-pulse' : ''
                            }`}></div>
                    </div>
                ...
                {/* Animated Border */}
                <div className={`absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 transition-all duration-300 ${isHovered ? 'opacity-20' : 'opacity-0'
